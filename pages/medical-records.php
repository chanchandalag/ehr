                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?=$rows['id_number'];?></td>
                       <td >
                          <a class="btn btn-primary btn-sm" href="/?page=medical-view&id=<?=$rows['id'];?>"><i class="fas fa-share-square"></i> View</a>
                          <a class="btn btn-info btn-sm" href="/?page=medical-view&id=<?=$rows['id'];?>"><i class="fas fa-pencil-alt"></i> Update</a>
