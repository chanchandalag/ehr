                       ...
                       <td >
                          <a class="btn btn-primary btn-sm dropdown-toggle" href="#" data-toggle="dropdown"><i class="fas fa-share-square"></i> Send</a>
                            <ul class="dropdown-menu">
                              <li>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/?page=medical-send&id=<?=$rows['id'];?>" class="fa fa-heartbeat"> Medical Records</a></li>
                              <li>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/?page=dental-send&id=<?=$rows['id'];?>" class="fa fa-hospital"> Dental Records</a></li>
                            </ul>
                          <a class="btn btn-info btn-sm" href="/?page=student-edit&id=<?=$rows['id'];?>"><i class="fas fa-pencil-alt"></i> Update</a>
